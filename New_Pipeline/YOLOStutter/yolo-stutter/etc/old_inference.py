...
if __name__ == "__main__":
    ...
    wav_path = "samples/p001_001_prolong.wav"
    ...
    print_full_tensor(disfluency_bound_pred)

    disf_words_pred = []
    bounds_pred = disfluency_bound_pred * 1024 * 256 / 22050
    print_full_tensor(bounds_pred)
    print(a)
